...
// router is a router support path pattern
...
// newRouter creates a new prefix router
...
func (r *router) getRoute(method, pattern string) (n *node, params map[string]string) {
